...
public class KasuP3Publisher {
    ...
    public static void sendConnectionDetails(int port, String hostname) throws IOException{
        try {
            ...
            Logger.getLogger(KasuP3Publisher.class.getName()).log(Level.SEVERE, null, ex);
        }
        
    }
    //method to send the participant type to dealing room server
  ...
  //method to send the topic to dealing room server
